        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxActiveStudents = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Posts_Trainers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Trainers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastPaymentStatus = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainerSubscriptions_PlatformPlans_PlatformPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TrainerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TrainerSubscriptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainerPayments_TrainerSubscriptions_TrainerSubscriptionId",
                        column: x => x.TrainerSubscriptionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentWorkoutSchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentWorkoutSchedules_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentWorkoutSchedules_Trainers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "Trainers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentWorkoutSchedules_Workouts_WorkoutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlatformPlans_Active",
                table: "PlatformPlans",
                column: "Active");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_TrainerId",
                table: "Posts",
                column: "TrainerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentWorkoutSchedules_StudentId",
                table: "StudentWorkoutSchedules",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentWorkoutSchedules_TrainerId",
                table: "StudentWorkoutSchedules",
                column: "TrainerId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentWorkoutSchedules_WorkoutId",
                table: "StudentWorkoutSchedules",
                column: "WorkoutId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerPayments_TrainerSubscriptionId",
                table: "TrainerPayments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerSubscriptions_PlatformPlanId",
